...
Item {
    ...
    height: Math.round(36 * PlasmaCore.Units.devicePixelRatio)//(PlasmaCore.Units.smallSpacing * 2) + Math.max(elementIcon.height+ PlasmaCore.Units.smallSpacing*2, titleElement.implicitHeight + PlasmaCore.Units.smallSpacing*2)
    ...
    Rectangle {
        anchors.fill: parent
        color: isCurrent || isHovered ? "#316ac5": "transparent"
        PlasmaCore.IconItem {
            id: elementIcon
            ...
            anchors {
                ...
                leftMargin: Math.round(2 * PlasmaCore.Units.devicePixelRatio)
                topMargin: Math.round(2 * PlasmaCore.Units.devicePixelRatio)
                bottomMargin: Math.round(2 * PlasmaCore.Units.devicePixelRatio)
                //verticalCenter: parent.verticalCenter
            }
            width: height//Math.round(32 * PlasmaCore.Units.devicePixelRatio)
            //height: width
        ...
        Label {
            ...
            color: isCurrent || isHovered ? "white": "#373738"
            font.family: "Tahoma"
            font.pointSize: 8
        ...
        /*Label {
            ...
            color: isCurrent || isHovered ? "white": "#808080"
            font.family: "Tahoma"
            font.pointSize: 8
