...
MouseArea {
    ...
    states: [
        ...
        State {
            name: "LauncherPressed"
            when: model.IsLauncher === true && task.pressed === true

            PropertyChanges {
                target: frame
                basePrefix: "QuickPressed"
            }
        },
        State {
            name: "LauncherHover"
        ...
        State {
            name: "Active"
            when: model.IsActive === true && task.highlighted === false
        ...
        State {
            name: "HoverInactive"
            when: model.IsActive === false && task.highlighted === true

            PropertyChanges {
                target: frame
                basePrefix: "HoverInactive"
            }
        },
        State {
            name: "HoverActive"
            when: model.IsActive === true && task.highlighted === true

            PropertyChanges {
                target: frame
                basePrefix: "HoverActive"
            }
        }
    ]
