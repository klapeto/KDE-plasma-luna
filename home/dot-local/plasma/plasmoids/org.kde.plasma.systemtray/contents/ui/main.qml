...
ContainmentItem {
    ...
    MouseArea {
        ...
        GridLayout {
            ...
            rowSpacing: 0
            columnSpacing: Math.round(-(expander.width / 2.0))
            anchors.fill: parent
            ...
            ExpanderArrow {
                ...
                anchors{
                    ...
                    left: parent.left
                    leftMargin: Math.round(-width / 2.0)
                }
            ...
            GridView {
                ...
                readonly property int totalHeightReduction: 14
                ...
                implicitHeight: root.vertical ? cellHeight * Math.ceil(count / rowsOrColumns) : autoSize ? root.height - totalHeightReduction : root.height
